...
namespace librbd {
  ...
  struct ImageCtx {
     ...
     * Lock ordering:
     *
     * owner_lock, md_lock, cache_lock, snap_lock, features_lock,
     * parent_lock, refresh_lock, object_map_lock, async_op_lock
     */
    ...
    RWLock snap_lock; // protects snapshot-related member variables, and flags
